...
// Profile dropdown options (translated)
const profileOptions = {
    en: {
        ...
        size: [
            {value: "", label: "-- Select --"},
            {value: "small", label: "Small (under 10,000 students)"},
            {value: "medium", label: "Medium (10,000-30,000 students)"},
            {value: "large", label: "Large (over 30,000 students)"}
        ],
        environment: [
            {value: "", label: "-- Select --"},
            {value: "urban", label: "Big city / Urban"},
            {value: "small-town", label: "Small town / Quiet"}
        ],
        learning: [
            {value: "", label: "-- Select --"},
            {value: "practical", label: "Practical / Hands-on"},
            {value: "theoretical", label: "Theoretical / Research-focused"},
            {value: "mixed", label: "Balanced mix of both"}
        ],
        priority: [
            {value: "", label: "-- Select --"},
            {value: "reputation", label: "University reputation"},
            {value: "innovation", label: "Innovation & modern facilities"},
            {value: "tradition", label: "Tradition & history"},
            {value: "international", label: "International environment"},
    ...
    de: {
        field: [
            ...
            {value: "engineering", label: "Ingenieurwesen & Technologie"},
            {value: "sciences", label: "Naturwissenschaften"},
            {value: "medicine", label: "Medizin & Gesundheit"},
            {value: "business", label: "Wirtschaft & Ökonomie"},
            {value: "humanities", label: "Geisteswissenschaften & Kunst"},
            {value: "social", label: "Sozialwissenschaften"},
            {value: "law", label: "Recht & Politik"}
        ],
        size: [
            {value: "", label: "-- Auswählen --"},
            {value: "small", label: "Klein (unter 10.000 Studenten)"},
            {value: "medium", label: "Mittel (10.000-30.000 Studenten)"},
            {value: "large", label: "Groß (über 30.000 Studenten)"}
        ],
        environment: [
            {value: "", label: "-- Auswählen --"},
            {value: "urban", label: "Großstadt / Urban"},
            {value: "small-town", label: "Kleinstadt / Ruhig"}
        ],
        learning: [
            {value: "", label: "-- Auswählen --"},
            {value: "practical", label: "Praktisch / Hands-on"},
            {value: "theoretical", label: "Theoretisch / Forschungsorientiert"},
            {value: "mixed", label: "Ausgewogene Mischung"}
        ],
        priority: [
            {value: "", label: "-- Auswählen --"},
            {value: "reputation", label: "Universitätsruf"},
            {value: "innovation", label: "Innovation & moderne Einrichtungen"},
            {value: "tradition", label: "Tradition & Geschichte"},
            {value: "international", label: "Internationale Umgebung"},
            {value: "career", label: "Karrieremöglichkeiten"}
        ]
    },
    it: {
        field: [
            {value: "", label: "-- Seleziona --"},
            {value: "engineering", label: "Ingegneria & Tecnologia"},
            {value: "sciences", label: "Scienze Naturali"},
            {value: "medicine", label: "Medicina & Salute"},
            {value: "business", label: "Business & Economia"},
            {value: "humanities", label: "Scienze Umane & Arte"},
            {value: "social", label: "Scienze Sociali"},
            {value: "law", label: "Giurisprudenza & Politica"}
        ],
        size: [
            {value: "", label: "-- Seleziona --"},
            {value: "small", label: "Piccola (sotto 10.000 studenti)"},
            {value: "medium", label: "Media (10.000-30.000 studenti)"},
            {value: "large", label: "Grande (oltre 30.000 studenti)"}
        ],
        environment: [
            {value: "", label: "-- Seleziona --"},
            {value: "urban", label: "Grande città / Urbano"},
            {value: "small-town", label: "Piccola città / Tranquillo"}
        ],
        learning: [
            {value: "", label: "-- Seleziona --"},
            {value: "practical", label: "Pratico / Hands-on"},
            {value: "theoretical", label: "Teorico / Orientato alla ricerca"},
            {value: "mixed", label: "Mix equilibrato"}
        ],
        priority: [
            {value: "", label: "-- Seleziona --"},
            {value: "reputation", label: "Reputazione universitaria"},
            {value: "innovation", label: "Innovazione & strutture moderne"},
            {value: "tradition", label: "Tradizione & storia"},
            {value: "international", label: "Ambiente internazionale"},
            {value: "career", label: "Opportunità di carriera"}
        ]
    }
};
...
function updateProfileDropdowns() {
    const opts = profileOptions[currentLang];
    ...
    updateSelect('profile-q1', opts.field);
    updateSelect('profile-q2', opts.size);
    updateSelect('profile-q3', opts.environment);
    updateSelect('profile-q4', opts.learning);
    updateSelect('profile-q5', opts.priority);
}
...
function startQuiz() {
    ...
    // Select 40 random questions from all available
    const allQuestions = questionsData[currentLang] || [];
    if (allQuestions.length === 0) {
        console.error('No questions found for language:', currentLang);
        alert('Error: Questions not loaded. Please refresh the page.');
        return;
    }
    questions = selectRandomQuestions(allQuestions);
    console.log('Loaded', questions.length, 'questions for', currentLang);
...
// Select 40 random questions from 80 total
function selectRandomQuestions(allQuestions) {
    if (allQuestions.length <= 40) return allQuestions;
...
function showQuestion(index) {
    ...
    } else if (question.type === 'choice' || question.type === 'country') {
